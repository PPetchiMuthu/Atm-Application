...
public class AccountTranstion {
    public void accountTransaction(int account, String name, int pinCode, int balance) {

        AccountTranstion object = new AccountTranstion();
        ...
        do {
            ...
            switch (loop) {
                case 1:
                    ...
                    object.modifyValue(account,(balance+amount));
                ...
                case 2:
                    ...
                    System.out.print("     Enter the amount : ");
                    amount = scan.nextInt();
                    if (amount <balance)  object.modifyValue(account,(balance - amount));
                    else {
    ...
    private void modifyValue(int account, int balance){
        try {
